...
Code for decomposing particulate backscatter signal into large and small particle components following the methods of (Briggs et al., 2020) and a modified version used in (Park et al., in review).
